...
-(void)initUI{
    ...
    self.labelRight=[LEUIFramework getUILabelWithSettings:[[LEAutoLayoutSettings alloc] initWithSuperView:self Anchor:LEAnchorInsideRightCenter Offset:CGPointMake(-self.CellLeftSpace*2, 0) CGSize:CGSizeMake(self.globalVar.ScreenWidth*2/3-self.CellLeftSpace*3, DefaultCellHeight-CellLeftSpaceAs*2)] LabelSettings:[[LEAutoLayoutLabelSettings alloc] initWithText:nil FontSize:15 Font:nil Width:0 Height:0 Color:ColorGrayText Line:0 Alignment:NSTextAlignmentRight]];
