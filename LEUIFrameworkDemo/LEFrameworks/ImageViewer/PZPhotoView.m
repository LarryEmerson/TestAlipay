...
@interface PZPhotoView () <UIScrollViewDelegate,SDWebImageManagerDelegate>
...
- (void)webImageManager:(SDWebImageManager *)imageManager didFinishWithImage:(UIImage *)image {
    ...
    [self.photoViewDelegate photoViewDidDownloadedImage];
}
//-(void) imageViewLoadedImage:(EGOImageView *)imageView{
//    if(![[LEImageCache instance].getHDImageCache objectForKey:imageView.imageURL.absoluteString]){
//        [[LEImageCache instance].getHDImageCache setObject:imageView.image forKey:imageView.imageURL.absoluteString];
//    }
//    [self.photoViewDelegate photoViewDidDownloadedImage];
//}
-(void) setImageURL:(NSString *) url AndAspect:(float) aspect{
    [self.imageView setFrame:CGRectMake(0, 0, 300, 300/aspect)];
